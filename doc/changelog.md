...
- Fix selections being kept after choosing a plant from the search list _(tschawax)_
- Fix placing new plants onto existing plants _(tschawax)_
- Fix select box while being in placement mode _(tschawax)_
- _()_
- _()_
