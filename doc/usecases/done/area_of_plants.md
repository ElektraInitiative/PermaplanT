...
- **Postcondition:**
  ...
  - If constraints are violated for the place where a plant was added or moved, relations get added (or removed) to (from) the [relation layer](../assigned/relation_layer.md).
