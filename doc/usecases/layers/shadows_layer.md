...
- **Level:** User Goal
- **Actors:** App User
- **Brief:** The user can add, edit, move and delete shadow areas in their plan using the shadow layer and adjust the intensity.
- **Status:** Draft
...
- **Main success scenario:**
  The user successfully adds, edits, moves and deletes shadow areas in their map using the shadow layer. 
...
- **Postcondition:**
  The user's plan includes the added, edited, moved or deleted shadow area as desired.
