...
ALTER TABLE plants DROP COLUMN propagation_transplanting_en;
...
ALTER TABLE plants DROP COLUMN when_to_plant_cuttings_en;
ALTER TABLE plants DROP COLUMN when_to_plant_division_en;
ALTER TABLE plants DROP COLUMN when_to_plant_transplant_en;
ALTER TABLE plants DROP COLUMN when_to_sow_indoors_en;
