...
ADD COLUMN alternate_name TEXT,
    ...
    ADD COLUMN propagation_transplanting_en TEXT,
    ...
    ADD COLUMN when_to_plant_cuttings_en TEXT,
    ADD COLUMN when_to_plant_division_en TEXT,
    ADD COLUMN when_to_plant_transplant_en TEXT,
    ADD COLUMN when_to_sow_indoors_en TEXT,
