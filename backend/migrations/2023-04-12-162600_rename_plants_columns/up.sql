-- Your SQL goes here
ALTER TABLE plants
    RENAME COLUMN binomial_name TO unique_name;
ALTER TABLE plants
    RENAME CONSTRAINT plant_detail_binomial_name_key TO plant_unique_name_key;
ALTER TABLE plants
...
ALTER TABLE plants DROP COLUMN environment;
