...
pub struct Plants {
    ...
    pub hardiness_zone: Option<std::ops::Range<i32>>,
    pub light_requirement: Option<Vec<LightRequirement>>,
    pub water_requirement: Option<Vec<WaterRequirement>>,
    pub propagation_method: Option<Vec<PropagationMethod>>,
    ...
    pub medicinal_parts: Option<Vec<String>>,
    ...
    pub reinsaat_article_number: Option<String>,
    pub reinsaat_portion_content: Option<String>,
    pub sowing_outdoors_de: Option<String>,
    pub reinsaat_url: Option<String>,
    ...
    pub _1000_seed_weight_de: Option<String>,
    pub _1000_seed_weight_en: Option<String>,
    pub _1000_seed_weight: Option<String>,
