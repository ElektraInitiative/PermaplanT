...
export default function IconButton({ variant = ButtonVariant.primary, ...props }: IconButtonProps) {
  ...
  const className =
    'inline-flex h-6 w-full items-center justify-center rounded-lg text-center text-sm font-medium focus:outline-none focus:ring-4 focus:ring-blue-300 stroke-neutral-800 dark:stroke-neutral-800-dark' +
    ' ' +
    colors[variant];
  return (
    <button
