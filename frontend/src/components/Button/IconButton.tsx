...
export default function IconButton({
  ...
  const activeIcon = renderAsActive
    ? 'fill-white dark:fill-primary-400 stroke-white  border-2 border-primary-500 bg-primary-500'
    : '';
  const toolboxIcon = isToolboxIcon
    ? 'mx-1 my-2 last-of-type:mr-2 h-8 w-8 p-1 border border-neutral-500 hover:bg-neutral-200 dark:hover:bg-neutral-800 dark:hover:stroke-primary-400 active:stroke-primary-400 active:fill-primary-400'
    : '';
