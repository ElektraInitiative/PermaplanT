...
export default function IconButton({ variant = ButtonVariant.primary, ...props }: IconButtonProps) {
  const colors = {
    [ButtonVariant.primary]: 'hover:text-primary-500 dark:hover:text-primary-500 hover:stroke-primary-500 dark:hover:stroke-primary-500 active:stroke-primary-200 dark:active:stroke-primary-200 hover:fill-primary-500 dark:hover:fill-primary-500 active:fill-primary-200 dark:active:fill-primary-200 focus:ring-primary-300 ',
    [ButtonVariant.secondary]: 'hover:text-secondary-500 dark:hover:text-secondary-500 hover:stroke-secondary-500 dark:hover:stroke-secondary-500 active:stroke-secondary-200 dark:active:stroke-secondary-200 hover:fill-secondary-500 dark:hover:fill-secondary-500 active:fill-secondary-200 dark:active:fill-secondary-200 focus:ring-secondary-300 ',
  };
  const className =
    ...
    ' disabled:stroke-neutral-500 dark:disabled:stroke-neutral-500-dark ' +
    ' ' +
    colors[variant];
  return (
    <button
