...
const variantStyles = {
  ...
  [ButtonVariant.primaryContainer]:
    'bg-primary-200 dark:bg-primary-600 border-primary-500 hover:bg-primary-400 dark:hover:bg-primary-400 active:bg-primary-500 dark:active:bg-primary-500 text-primary-900 dark:text-primary-200',
  [ButtonVariant.secondaryContainer]:
    'bg-secondary-200 dark:bg-secondary-600 border-secondary-500 hover:bg-secondary-400 dark:hover:bg-secondary-400 active:bg-secondary-900 dark:active:bg-secondary-900 text-secondary-900 dark:text-secondary-200',
