      ...
      <div className="container mx-auto py-24">
        <div className="-m-12 flex flex-wrap">
          <div className="flex flex-col items-start p-12 md:w-1/2">
            <h2 className="title-font mt-4 mb-4 text-2xl font-medium text-neutral-900 sm:text-3xl">
            ...
            <div className="mb-4 mt-auto flex w-full flex-wrap items-center border-b-2 border-neutral-100 pb-4">
              <span className="mr-3 ml-auto inline-flex items-center text-sm leading-none text-neutral-600">
                04.04.2023
              </span>
            </div>
